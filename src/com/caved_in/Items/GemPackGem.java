...
public class GemPackGem extends CustomMaterial
{
	private String[] Gem_Prefixes = { "Emaculate Gem of ", "Pristine Gem of ", "Untainted Gem of ", "Magnificent Gem of ", "Enriched Gem of ", "Perfected Gem of ", "Polished Gem of " };
	...
	private int[] Enchantment_Levels = { 12, 11, 10, 8, 6, 5, 4 };

	public GemPackGem(String id, Material material)
	{
		super(id, material);
