...
public class EmbuedGem extends CustomMaterial
{
	private String[] Gem_Prefixes = { "Perfected Gem of ", "Polished Gem of ", "Refined Gem of ", "Cracked Gem of ", "Crude Gem of " };
	private String[] Enchantment_Names = { "Strength", "Force", "Rewards", "Sharp Shooting", "Endurance", "Arachnid Elimination", "Undead Damaging", "Preservation" };
	private Enchantment[] Enchants = { Enchantment.DAMAGE_ALL, Enchantment.KNOCKBACK, Enchantment.LOOT_BONUS_MOBS, Enchantment.ARROW_DAMAGE, Enchantment.DURABILITY, Enchantment.DAMAGE_ARTHROPODS, Enchantment.DAMAGE_UNDEAD, Enchantment.SILK_TOUCH };
	private int[] Enchantment_Levels = { 5, 4, 3, 2, 1 };

	public EmbuedGem(String id, Material material)
	{
		super(id, material);
