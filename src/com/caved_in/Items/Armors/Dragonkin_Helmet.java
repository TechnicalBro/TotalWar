...
public class Dragonkin_Helmet extends CustomMaterial
{

	private ChatColor Name_Color = ChatColor.RED;
	private String Item_Name = "DragonKin Helmet";
	private String[] Item_Lore = new String[] { "Born in the flames of Jodies Rage", "Legend says a full set of dragonkin", "armor will have wonderful effects" };
	...
	public Dragonkin_Helmet(String id, Material material)
	{
		super(id, material);
