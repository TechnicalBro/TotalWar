...
public class Dragonkin_Boots extends CustomMaterial
{

	private ChatColor Name_Color = ChatColor.RED;
	private String Item_Name = "DragonKin Grieves";
	private String[] Item_Lore = new String[] { "Crafted from the skin of Jodies fallen foes", "Legend says a full set of dragonkin armor will have wonderful effects" };
	...
	public Dragonkin_Boots(String id, Material material)
	{
		super(id, material);
