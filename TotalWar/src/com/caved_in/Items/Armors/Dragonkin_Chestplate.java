...
public class Dragonkin_Chestplate extends CustomMaterial
{

	private ChatColor Name_Color = ChatColor.RED;
	private String Item_Name = "DragonKin Chestplate";
	private String[] Item_Lore = new String[] { "Built from the bones of Jodies fallen foes", "Legend says a full set of dragonkin armor will have wonderful effects" };
	...
	public Dragonkin_Chestplate(String id, Material material)
	{
		super(id, material);
