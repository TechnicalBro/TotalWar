...
public class LeatherBoots extends CustomMaterial
{
	private String[] Prefixes_Common = { "Mediocre", "Worn", "Damaged", "Tired", "Second Hand", "Home-Made" };
	private String[] Prefixes_Rare = { "Sturdy", "Premium", "Well-Built", "Fine" };
	private String[] Prefixes_Epic = { "Perfect", "Excellent", "Steel Enforced" };
	private String[] Suffix_Common = { "Fur", "Adventuring", "the Adventurer", "Minor Defence", "Beginners", "the Noob", "Newbies" };
	...
	private String Weapon_Name = " Leather Boots";
	...
	public LeatherBoots(String id, Material material, Tier Item_Quality)
	{
		super(id, Material.LEATHER_BOOTS);
		...
		setLore(new String[] { ChatColor.RED + "Increases Max HP by " + Damage + "!" });
	}
 ...
 * com.caved_in.Items.Armors.LeatherBoots JD-Core Version: 0.6.2
 */