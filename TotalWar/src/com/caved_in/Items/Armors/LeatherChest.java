...
public class LeatherChest extends CustomMaterial
{
	...
	private String[] Suffix_Common = { "Adventuring", "the Adventurer", "Minor Defence", "Beginners", "the Noob", "Newbies" };
	...
	private String Weapon_Name = " Leather Chest";
	...
	public LeatherChest(String id, Material material, Tier Item_Quality)
	{
		super(id, Material.LEATHER_CHESTPLATE);
 ...
 * com.caved_in.Items.Armors.LeatherChest JD-Core Version: 0.6.2
 */