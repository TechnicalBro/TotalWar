...
public class Runnables
{
	public Runnables(TotalWar Plugin)
	{
		...
		Plugin.getServer().getScheduler().scheduleSyncRepeatingTask(Plugin, new BossAttackRunnable(), 120L, 50L);
		Plugin.getServer().getScheduler().scheduleSyncRepeatingTask(Plugin, new ManaRegen(), 60L, 100L);
		Plugin.getServer().getScheduler().scheduleSyncRepeatingTask(Plugin, new ArmorEffects(), 80L, 85L);
	}
}